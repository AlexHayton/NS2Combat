...
function InitBackgroundFileNames( out )
    ...
    if mapname ~= '' then
        ...
        for i = 1,100 do
            ...
            local searchResult = {}
            Shared.GetMatchingFileNames("screens/combat*.jpg", true, searchResult)
...
function OnLoadComplete()
    ...
    local spinnerOffset = GUIScale(100)

    spinner = GUI.CreateItem()
    spinner:SetTexture("ui/loading/loading_bottom.dds")
    ...
    local statusOffset = GUIScale(100)
